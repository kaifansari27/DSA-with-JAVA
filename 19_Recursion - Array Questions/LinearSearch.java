...
public class LinearSearch {
    public static void main(String[] args) {
        ...
        System.out.println(findAllIndexWithAL(arr, 4, 0, new ArrayList<>()));
    ...
    static ArrayList<Integer> findAllIndexWithAL(int[] arr, int target, int index, ArrayList<Integer> list) {
        if (index == arr.length) {
            return list;
        }
        if (arr[index] == target) {
        ...
        return findAllIndexWithAL(arr, target, index + 1, list);
    }
}
